...
| Fonction | Détail |
|---|---|
| **Valider** | Un message conforme = 1 photo + une légende qui ne contient que le numéro attendu (compteur + 1) |
...
- ✅ **Phase locale** — tout ce qui se teste sans connexion WhatsApp : base de
  ...
  parsing de l'export, import de l'historique. 58 tests, tous verts.
...
tests/               # 58 tests, aucun ne nécessite de connexion WhatsApp
